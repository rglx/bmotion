...
proc bMotion_plugin_complex_supermarket { nick host handle channel text } {
  ...
  if [regexp -nocase {\m(sainsbury\'s|sainsburys|safeway|aldi|asda|walmart|wal-mart|wal mart|somerfield|lidl|co-op|budgens|cws|kiwk-save|kwiksave|kwik save|budgens|iceland|circle k|k-mart|7-11|costcutter|costco|marks and spencers|m&s|marks and sparks|mace-line|qfc|haggen|albertsons|albertson\'s)\M} $text matches where ] {
