...
proc bMotion_plugin_admin_abstract_help { } {
	...
	bMotion_putadmin "  .bmotion abstract info <abstract> - Find out info about an abstract"
	bMotion_putadmin "  .bmotion abstract show <abstract> - List the contents of an abstract (Potentially much output!)"
	bMotion_putadmin "  .bmotion abstract gc - Force a garbage collection of abstracts (pages out unused ones)"
	bMotion_putadmin "  .bmotion abstract status - List all abstracts and their status (Much ouput!)"
	bMotion_putadmin "  .bmotion abstract delete <abstract> <index> - Delete an element from an abstract - Index is 0-based; use the show command to find entries"
	bMotion_putadmin "  .bmotion abstract purge <abstract> <regexp> - Remove all matching elements from an abstract (dangerous)"
	bMotion_putadmin "  .bmotion abstract flush - Force all abstracts to be flushed to disk"
	bMotion_putadmin "  .bmotion abstract filter add <abstract> <regexp> - Add a filter to an abstract"
	bMotion_putadmin "  .bmotion abstract filter list - List all abstract filters"
	bMotion_putadmin "  .bmotion abstract filter purge - Purge all filters"
	bMotion_putadmin "  .bmotion abstract filter apply <abstract> - For an abstract to be filtered now"
	bMotion_putadmin "  .bmotion abstract diagnose - Test all abstracts for parsability and report any broken ones"
	bMotion_putadmin "  .bmotion abstract reset <abstract> - Remove everything from an abstract and save it"
	return 0
}
